...
\startxmlsetups xml:h2
    \xmldoifelse{#1}{.[contains(@class,'unnumbered')]}{%
        \subject[\xmlatt{#1}{id}]{\xmlflush{#1}}%
    }{%
...
\startxmlsetups xml:h3
    \xmldoifelse{#1}{.[contains(@class,'unnumbered')]}{%
        \subsubject[\xmlatt{#1}{id}]{\xmlflush{#1}}%
    }{%
        \subsection[\xmlatt{#1}{id}]{\xmlflush{#1}}%
    }
\stopxmlsetups

\startxmlsetups xml:h4
    \xmldoifelse{#1}{.[contains(@class,'unnumbered')]}{%
        \subsubsubject[\xmlatt{#1}{id}]{\xmlflush{#1}}%
    }{%
        \subsubsection[\xmlatt{#1}{id}]{\xmlflush{#1}}%
    }
\stopxmlsetups

\startxmlsetups xml:h5
    \xmldoifelse{#1}{.[contains(@class,'unnumbered')]}{%
        \subsubsubsubject[\xmlatt{#1}{id}]{\xmlflush{#1}}%
    }{%
        \subsubsubsection[\xmlatt{#1}{id}]{\xmlflush{#1}}%
    }
\stopxmlsetups

\startxmlsetups xml:h6
    \xmldoifelse{#1}{.[contains(@class,'unnumbered')]}{%
        \subsubsubsubsubject[\xmlatt{#1}{id}]{\xmlflush{#1}}%
    }{%
        \subsubsubsubsection[\xmlatt{#1}{id}]{\xmlflush{#1}}%
    }
\stopxmlsetups
...
\startxmlsetups xml:internal:link
    \xmlflush{#1} {
        %\em%
        %\doiftext{\in[\xmlrefatt{#1}{href}]}{\in[\xmlrefatt{#1}{href}]. }%
        %\about[\xmlrefatt{#1}{href}]%
        \in[\xmlrefatt{#1}{href}]%
    }
\stopxmlsetups
